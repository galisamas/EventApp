...
import com.itworks.eventapp.helpers.*;
import com.itworks.eventapp.helpers.comparators.TimetableListComparator;
import com.itworks.eventapp.models.TimetableModel;
...
public class MenuBottomFragment extends Fragment {
    ...
    private void setTimetableForBottom() {
        ...
        TimetableModel timetable2 = modelsController.getTimetable(timetableModels, 1); // TODO kartais buna kad rodo du vienodus
