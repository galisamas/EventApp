...
import com.itworks.eventapp.BaseFragment;
import com.itworks.eventapp.R;
import com.itworks.eventapp.helpers.BrowserController;
...
import com.itworks.eventapp.models.FoodModel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        place.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FoodInfoFragment.this.startActivityForResult(intent, 0);
